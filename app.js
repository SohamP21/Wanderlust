...
const { listingSchema, reviewSchema } = require("./schema.js");
const Review = require("./models/review.js");
const Listing = require("./models/listing.js"); // Added import
...
async function main() {
  await mongoose.connect(dbUrl, {
    ...
    useUnifiedTopology: true,
    // tls: true,
    // For SSL debugging, you can temporarily allow invalid certs (not recommended for production)
...
// Listen on Render's port or fallback 8080
